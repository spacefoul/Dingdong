...
//}
//
//let availableColors: [ThemeColorOption] = [
//	.init(name: "Blue", color: .blue.opacity(0.6)),
//	.init(name: "Red", color: .red.opacity(0.6)),
//	.init(name: "Green", color: .green.opacity(0.6)),
//	.init(name: "Purple", color: .purple.opacity(0.6)),
//	.init(name: "Orange", color: .orange.opacity(0.6))
//]
